...
県名・市名は、店舗や商業施設の所在地として書かれているだけでは対象にしません。過去の自治体案件に共通する「県内」「県の対象店舗」「市で最大○％」「自治体キャンペーン」などの地域還元文言を必要とし、「対象店舗で使える割引クーポン」「○○店限定」のような店舗・施設独自企画は除外します。au PAYは記事自身のタイトルにある「自治体キャンペーン」表記も必須とし、ページ下部の関連記事だけで還元案件と誤認しないようにしています。
